...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.battle.default_max_turns, 1000);
        assert!(config.performance.cache_moves);
    }
    ...
    fn test_config_builder() {
        ...
        assert!(config.logging.debug);
        assert_eq!(config.battle.default_max_turns, 500);
    ...
    fn test_config_serialization() {
        ...
        assert_eq!(config.battle.default_max_turns, deserialized.battle.default_max_turns);
    ...
    fn test_config_file_operations() {
        ...
        assert!(loaded_config.logging.debug);
        assert_eq!(loaded_config.battle.default_max_turns, 123);
    }
    ...
    fn test_effective_thread_count() {
        ...
        let effective = config.effective_thread_count();
        assert!(effective > 0);
