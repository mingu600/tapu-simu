...
/// Modern team builder with standardized interface
pub struct ModernTeamBuilder<'a> {
...
impl<'a> Builder<Vec<RandomPokemonSet>> for ModernTeamBuilder<'a> {
...
impl<'a> ValidatingBuilder<Vec<RandomPokemonSet>> for ModernTeamBuilder<'a> {
...
pub struct TeamPokemonContext<'a> {
    team_builder: ModernTeamBuilder<'a>,
...
impl<'a> TeamPokemonContext<'a> {
    ...
    pub fn finish(mut self) -> ModernTeamBuilder<'a> {
