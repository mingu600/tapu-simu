...
mod tests {
    ...
    fn test_life_orb() {
        ...
        let modifier = get_stat_boosting_item_effect(
            "lifeorb",
            &generation,
            &pokemon,
            None,
        ...
        assert_eq!(modifier.power_multiplier, 1.3);
        assert_eq!(modifier.recoil_percentage, 0.1);
    }

    #[test]
    fn test_muscle_band_physical() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let pokemon = Pokemon::default();
        let context = DamageContext::default();
    ...
    fn test_assault_vest() {
        ...
        assert_eq!(modifier.special_defense_multiplier, 1.5);
    }
    ...
    fn test_air_balloon() {
        ...
        assert!(modifier.ground_immunity);
    }
    ...
    fn test_heavy_duty_boots() {
        ...
        assert!(modifier.hazard_immunity);
    }

    #[test]
    fn test_absorb_bulb_water_move() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let pokemon = Pokemon::default();
        let context = DamageContext::default();
        ...
        assert_eq!(modifier.stat_boosts.unwrap().special_attack, 1);
        assert!(modifier.is_consumed);
    }

    #[test]
    fn test_absorb_bulb_non_water_move() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let pokemon = Pokemon::default();
        let context = DamageContext::default();
    ...
    #[test]
    fn test_cell_battery_electric_move() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let pokemon = Pokemon::default();
        let context = DamageContext::default();
    ...
    fn test_shell_bell() {
        ...
        assert_eq!(modifier.drain_percentage, 0.125);
    }

    #[test]
    fn test_normal_gem_gen5() {
        let generation = GenerationMechanics::new(Generation::Gen9); // Would need Gen5Mechanics for accurate test
        let pokemon = Pokemon::default();
        let context = DamageContext::default();
        ...
        assert_eq!(modifier.power_multiplier, 1.3); // Gen 6+ multiplier
        assert!(modifier.is_consumed);
    }

    #[test]
    fn test_normal_gem_wrong_type() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let pokemon = Pokemon::default();
        let context = DamageContext::default();
    ...
    fn test_electric_seed() {
        ...
        assert!(modifier.stat_boosts.is_some());
        assert_eq!(modifier.stat_boosts.unwrap().defense, 1);
        assert!(modifier.is_consumed);
    }
    ...
    fn test_misty_seed() {
        ...
        assert!(modifier.stat_boosts.is_some());
        assert_eq!(modifier.stat_boosts.unwrap().special_defense, 1);
        assert!(modifier.is_consumed);
    }

    #[test]
    fn test_non_stat_boosting_item() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let pokemon = Pokemon::default();
        let context = DamageContext::default();
