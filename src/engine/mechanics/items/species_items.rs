...
mod tests {
    ...
    fn test_thick_club_cubone() {
        ...
        assert_eq!(modifier.attack_multiplier, 2.0);
    }

    #[test]
    fn test_thick_club_marowak() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "marowak".to_string();
        let context = DamageContext::default();
    ...
    #[test]
    fn test_thick_club_wrong_pokemon() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "pikachu".to_string();
        let context = DamageContext::default();
    ...
    #[test]
    fn test_light_ball_pikachu_physical() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "pikachu".to_string();
        let context = DamageContext::default();
    ...
    #[test]
    fn test_light_ball_pikachu_special() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "pikachu".to_string();
        let context = DamageContext::default();
        ...
        assert_eq!(modifier.attack_multiplier, 1.0);
        assert_eq!(modifier.special_attack_multiplier, 2.0);
    }

    #[test]
    fn test_adamant_orb_dialga_dragon_move() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "dialga".to_string();
        let context = DamageContext::default();
    ...
    #[test]
    fn test_adamant_orb_dialga_steel_move() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "dialga".to_string();
        let context = DamageContext::default();
    ...
    #[test]
    fn test_adamant_orb_dialga_other_move() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "dialga".to_string();
        let context = DamageContext::default();
    ...
    #[test]
    fn test_ogerpon_cornerstone_mask() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "ogerpon-cornerstone".to_string();
        let context = DamageContext::default();
    ...
    #[test]
    fn test_ogerpon_wrong_mask() {
        let generation = GenerationMechanics::new(Generation::Gen9);
        let mut pokemon = Pokemon::default();
        pokemon.species = "ogerpon-hearthflame".to_string();
        let context = DamageContext::default();
