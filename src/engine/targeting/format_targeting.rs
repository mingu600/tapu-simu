...
impl FormatMoveTargetResolver {
    ...
    fn resolve_targets_for_move_target(
        ...
        let ps_engine = super::auto_targeting::PSAutoTargetingEngine::new(self.format.clone());
...
pub struct AutoTargetingEngine {
    ps_engine: crate::engine::targeting::auto_targeting::PSAutoTargetingEngine,
}
...
impl AutoTargetingEngine {
    ...
    pub fn new(format: BattleFormat) -> Self {
        Self {
            ps_engine: super::auto_targeting::PSAutoTargetingEngine::new(format),
        }
    }
