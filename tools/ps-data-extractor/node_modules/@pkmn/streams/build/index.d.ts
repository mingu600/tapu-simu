...
declare class ReadWriteStream extends ReadStream implements WriteStream {
    isReadable: true;
    isWritable: true;
    nodeWritableStream: NodeJS.WritableStream | null;
    drainListeners: (() => void)[];
...
declare class ObjectReadStream<T> {
    buf: T[];
    readSize: number;
    atEOF: boolean;
    errorBuf: Error[] | null;
...
declare class ObjectWriteStream<T> {
    isReadable: boolean;
    isWritable: true;
    nodeWritableStream: NodeJS.WritableStream | null;
...
declare class ObjectReadWriteStream<T> extends ObjectReadStream<T> implements ObjectWriteStream<T> {
    isReadable: true;
    isWritable: true;
    nodeWritableStream: NodeJS.WritableStream | null;
...
declare function readAll(nodeStream: NodeJS.ReadableStream, encoding?: any): Promise<string>;
declare function stdin(): ReadStream;
declare function stdout(): WriteStream;
declare function stdpipe(stream: WriteStream | ReadStream | ReadWriteStream): Promise<void[]>;

export { ObjectReadStream, ObjectReadWriteStream, ObjectWriteStream, ReadStream, ReadWriteStream, WriteStream, readAll, stdin, stdout, stdpipe };
