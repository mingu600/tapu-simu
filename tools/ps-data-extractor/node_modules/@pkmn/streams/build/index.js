...
var ReadStream = class {
  ...
  async readLine(encoding = this.encoding) {
    ...
    if (line == null ? void 0 : line.endsWith("\r"))
      line = line.slice(0, -1);
    return line;
  }
  destroy() {
...
var ReadWriteStream = class extends ReadStream {
  constructor(options = {}) {
    super(options);
    this.isReadable = true;
    this.isWritable = true;
...
var ObjectReadWriteStream = class extends ObjectReadStream {
  constructor(options = {}) {
    super(options);
    this.isReadable = true;
    this.isWritable = true;
...
exports.ObjectReadStream = ObjectReadStream; exports.ObjectReadWriteStream = ObjectReadWriteStream; exports.ObjectWriteStream = ObjectWriteStream; exports.ReadStream = ReadStream; exports.ReadWriteStream = ReadWriteStream; exports.WriteStream = WriteStream; exports.readAll = readAll; exports.stdin = stdin; exports.stdout = stdout; exports.stdpipe = stdpipe;
/**
 * Streams
